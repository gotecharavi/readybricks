                  <div class="table-responsive">
                        ...
                        <thead>
                            <tr>
                                <th>Transporter Name</th><th>RC No.</th><th>Vehicle Number</th><th>Status</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tfoot>
                        ...
                        <tbody>
                            <tr ng-repeat="item in list.vehicle">
                                ...
                                <td class="text-center">
                                   <a href="<?php echo site_url(); ?>/#/viewRequestProfile?user=Vehicle&type=New&id={{item.VId}}" ng-if="item.IsEdited == 0 && item.IsAccount !=1" class="btn btn-outline-info"> <i class="os-icon os-icon-eye" style="margin-top: -3px;"></i></a>
                                   <a href="<?php echo site_url(); ?>/#/viewRequestProfile?user=Vehicle&type=Edited&id={{item.VId}}"  ng-if="item.IsEdited == 1 && item.IsAccount !=0" class="btn btn-outline-info"> <i class="os-icon os-icon-eye" style="margin-top: -3px;"></i></a>


                                </td>
                            </tr>
                            <tr ng-show="list.vehicle.length ==0"><td colspan="10" class="text-center">Vehicel Not found</td></tr>

                            </tbody></table>
                  </div>

                            <div class="row"><div class="col-sm-12 col-md-5">
                                    <div class="dataTables_info" id="dataTable1_info" role="status" aria-live="polite">Showing {{pagingOptions.currentPage}} to {{totalpaging}} of {{totalItems.vehicle}} entries</div></div>
