                        ...
                        <tbody>
                            <tr ng-repeat="item in list.transporter">
                                ...
                                <td class="text-center">
                                   <a href="<?php echo site_url(); ?>/#/viewRequestProfile?user=Transporter&type=Edited&id={{item.UserId}}" ng-if="item.IsEdited == 1 && item.IsAccount !=0" class="btn btn-outline-info"> <i class="os-icon os-icon-eye" style="margin-top: -3px;"></i></a>
                                   <a href="<?php echo site_url(); ?>/#/viewRequestProfile?user=Transporter&type=New&id={{item.UserId}}" ng-if="item.IsEdited == 0 && item.IsAccount !=1" class="btn btn-outline-info"> <i class="os-icon os-icon-eye" style="margin-top: -3px;"></i></a>
                                </td>
                            </tr>
                            <tr ng-show="list.transporter.length ==0"><td colspan="10" class="text-center">Records Not found</td></tr>
                            ...
                            <div class="row"><div class="col-sm-12 col-md-5">
                                    <div class="dataTables_info" id="dataTable1_info" role="status" aria-live="polite">Showing {{pagingOptions.currentPage}} to {{totalpaging}} of {{totalItems.transporter}} entries</div></div>
