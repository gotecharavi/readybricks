                  <div class="table-responsive">
                        ...
                        <thead>
                            <tr>
                                <th>Transporter Name</th> <th>Name</th><th>Phone No</th> <th>Status</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tfoot>
                        ...
                        <tbody>
                            <tr ng-repeat="item in list.driver">
                                ...
                                <td class="text-center">
                                   <a href="<?php echo site_url(); ?>/#/viewRequestProfile?user=Driver&type=New&id={{item.DId}}"  ng-if="item.IsEdited == 0 && item.IsAccount !=1" class="btn btn-outline-info"> <i class="os-icon os-icon-eye"></i></a>
                                   <a href="<?php echo site_url(); ?>/#/viewRequestProfile?user=Driver&type=Edited&id={{item.DId}}"  ng-if="item.IsEdited == 1 && item.IsAccount !=0" class="btn btn-outline-info"> <i class="os-icon os-icon-eye"></i></a>

                                </td>
                            </tr>
                            <tr ng-show="list.driver.length ==0"><td colspan="10" class="text-center">Driver Not found</td></tr>

                            </tbody></table>
                  </div>

                            <div class="row"><div class="col-sm-12 col-md-5">
                                    <div class="dataTables_info" id="dataTable1_info" role="status" aria-live="polite">Showing {{pagingOptions.currentPage}} to {{totalpaging}} of {{totalItems.driver}} entries</div></div>
