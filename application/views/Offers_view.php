<script src="static/appScript/OffersCtrl.js"></script>
...
<!--                             <div class="col-sm-12 col-md-6">
                        ...
                        <tbody>
                            <tr ng-repeat="item in list">
                                <td><img src="<?php echo base_url(); ?>uploads/{{item.OImage}}" width="120px" ng-if="item.OImage !=''"></td>
                            ...
                            <tr ng-show="list.length ==0"><td colspan="10" class="text-center">Offers Not found</td></tr>
...
<div ng-show="!fgShowHide" style="display:none">
    <div class="element-wrapper">
                <h6 class="element-header">{{datatype}} Offers</h6>
