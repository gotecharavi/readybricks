...
<div class="element-wrapper" ng-show="viewItemDetail">
     <!-- Datatables Content -->
                <h6 class="element-header">
                  Manage Order
                </h6>
                <div class="element-box">
                  <div class="table-responsive">
                    ...
                    <tr ng-repeat="item in itemList">
                        ...
                        <td class="text-capitalize">{{item.TotalProduct }}</td>
                        <td>
                            <a ng-show="item.OdStatus == '1'" class="badge badge-danger" href="">Queue</a>
                            <a ng-show="item.OdStatus == '2'" class="badge badge-success" href="">Pending</a>
                            <a ng-show="item.OdStatus == '4'" class="badge badge-primary" href="">Completed</a>
                        </td>

                        <td>
                        <button type="button" class="ml-3 btn  btn-xs btn-warning" ng-click="orderDetail(item)"><i class="os-icon os-icon-eye" style="margin-top: -3px;"></i></button>
                        <button type="button" class="btn  btn-xs btn-danger" ng-click="deleteItem(item.OrderId)"><i class="os-icon os-icon-ui-15" style="margin-top: -3px;"></i></button> </td>
