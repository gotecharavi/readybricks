...
<!--                   <div class="form-desc">
 ...
 -->                  <div class="table-responsive">
                        ...
                        <tr ng-repeat="item in list">
                                ...
                                <td>
                                    <a class="badge badge-danger" href="" ng-if="item.PStatus == 0">Deactive</a>
                                    <a class="badge badge-success" href="" ng-if="item.PStatus== 1">Active</a>
                                </td>
                                <td class="text-center">
                                   <button type="button" class=" mb-2 btn  btn-xs btn-danger" ng-click="changeItemStatus(item.ProductId,0)" ng-if="item.PStatus == 1">Deactive</button> 
                                   <button type="button" class=" mb-2 btn  btn-xs btn-success" ng-click="changeItemStatus(item.ProductId,1)" ng-if="item.PStatus == 0">Active</button>

                                    <button class="ml-0 mb-2 btn btn-outline-info " ng-click="editItem(item)" type="button">  <i class="os-icon os-icon-ui-49" style="margin-top: -3px;"></i></button>
                            ...
                            <tr ng-show="list.length ==0"><td colspan="10" class="text-center">Product Not found</td></tr>
