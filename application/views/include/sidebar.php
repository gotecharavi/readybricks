      ...
      <div class="layout-w">
        ...
        <div class="menu-mobile menu-activated-on-click color-scheme-dark">
          <div class="mm-logo-buttons-w">
            <a class="mm-logo" href="index.html"><img src="<?php echo base_url(); ?>/static/img/logo.png"><span>Clean Admin</span></a>
          ...
          <div class="menu-and-user">
            <div class="logged-user-w">
              <div class="avatar-w">
                <img alt="" src="<?php echo base_url(); ?>/static/img/avatar1.jpg">
              </div>
        ...
        --------------------><!--------------------
        START - Main Menu 
       class="isMiniMenu ? 'menu-layout-mini sub-menu-style-over menu-activated-on-hover':'menu-layout-compact sub-menu-style-inside menu-activated-on-click'"

        -------------------->
        <div class="menu-w color-scheme-light color-style-transparent menu-position-side menu-side-left  sub-menu-color-light selected-menu-color-light  menu-has-selected-link
        menu-layout-compact sub-menu-style-inside menu-activated-on-click
        " id="main-menu" >
          <div class="logo-w" style="background-color: #0e2c36;padding: 14px 0rem 14px 0rem; border-radius: inherit;">
            <a class="logo" href="#">
              <img src="<?php echo base_url(); ?>/favicon.png" style="margin-left:1rem;">
              <div class="logo-label" style="color:#fff;font-weight: bold; font-size: 22px;margin: 0px;">
                <span style="color:#fff;margin-left:0.5rem">READY</span> <span style="color:#f44343;margin: 0px;">BRICKS</span>
              </div>
<!--               <div class="logo-element"></div>
 ...
 -->            </a>
          ...
          <!--       <ul>
                  ...
                  <li>
                    <a href="<?php echo site_url(); ?>/login/logout" ><i class="os-icon os-icon-signs-11"></i><span>Logout</span></a>
                  </li>
                </ul> -->
              </div>
            </div>
          ...
          <ul class="main-menu">
            ...
            <li class="">
              <a href="<?php echo site_url(); ?>/#/Dashboard"><div class="icon-w"><div class="os-icon os-icon-layout"></div></div><span>Dashboard</span></a>
            </li>
            <li class="">
              <a href="<?php echo site_url(); ?>/#/Roles"><div class="icon-w"><div class="os-icon os-icon-file-text"></div></div><span>Roles</span></a>
            </li>
            <li class="">
              <a href="<?php echo site_url(); ?>/#/Customer"><div class="icon-w"><div class="os-icon os-icon-menu"></div></div><span>Manage Customer</span></a>
            </li>
            <li class="">
              <a href="<?php echo site_url(); ?>/#/Manufacture"><div class="icon-w"><div class="os-icon os-icon-menu"></div></div><span>Manage Manufacture</span></a>
            </li>
            <li class="">
              <a href="<?php echo site_url(); ?>/#/Transporter"><div class="icon-w"><div class="os-icon os-icon-menu"></div></div><span>Manage Transporter</span></a>
            </li>

            <li class=" has-sub-menu">
              <a href="javascript:void(0);"><div class="icon-w"><div class="os-icon os-icon-menu"></div></div><span>Manage Transports</span></a>
              <div class="sub-menu-w">
                    <div class="sub-menu-header">Manage Transports</div>
            ...
            <li class="">
              <a href="<?php echo site_url(); ?>/#/Requests"><div class="icon-w"><div class="os-icon os-icon-menu"></div></div><span>Manage Requests</span></a>
            </li>

            <li class=" has-sub-menu">
              <a href="javascript:void(0);"><div class="icon-w"><div class="os-icon os-icon-ui-02"></div></div><span>Ecommerce</span></a>
              <div class="sub-menu-w">
                    <div class="sub-menu-header">Manage Ecommerce</div>
                <div class="sub-menu-icon"><i class="os-icon os-icon-layout"></i></div>
                <div class="sub-menu-i">
                    <ul class="sub-menu">
            ...
            <li class=" has-sub-menu">
              <a href="javascript:void(0);"><div class="icon-w"><div class="os-icon os-icon-navigation"></div></div><span>Manage Location</span></a>
              <div class="sub-menu-w">
                    <div class="sub-menu-header">Manage Location</div>
                <div class="sub-menu-icon"><i class="os-icon os-icon-layout"></i></div>
                <div class="sub-menu-i">
                    <ul class="sub-menu">
                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <a href="./index.php/#" class="sidebar-brand">
                                <span class="sidebar-nav-mini-hide"><strong>All About Electronics</strong></span>
                            </a>
                            <!-- END Brand -->
                            ...
                            <div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
                                <div class="sidebar-user-avatar">
                                    <a href="<?php echo site_url(); ?>/#/editprofile">
                                        <img src="<?php base_url(); ?>static/img/placeholders/avatars/avatar2.jpg" alt="avatar">
                                    </a>
                                </div>
                                <div class="sidebar-user-name"><?php echo $this->session->userdata('user')->FirstName." ".$this->session->userdata('user')->LastName ?></div>
                                    <div class="sidebar-user-links">
                                    <a href="<?php echo site_url(); ?>/#/editprofile" data-toggle="tooltip" data-placement="bottom" title="Profile"><i class="gi gi-user"></i></a>
                                   
                                    <!-- Opens the user settings modal that can be found at the bottom of each page (page_footer.html in PHP version) -->
                                   
                                    <a href="<?php echo site_url(); ?>/login/logout" data-toggle="tooltip" data-placement="bottom" title="Logout"><i class="gi gi-exit"></i></a>
                                </div>
                            </div>
                            <!-- END User Info -->
...
<!--                                 <li>
                                    <a href="<?php echo site_url(); ?>/#/" class=" active"><i class="gi gi-stopwatch sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Dashboard</span></a>
                                </li> -->
                                <li>
                                    <a href="<?php echo site_url(); ?>/#/Models" ><i class="fa  fa-star sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Models</span></a>
                                </li> 
                                <li>
                                    <a href="<?php echo site_url(); ?>/#/Pump" ><i class="fa  fa-object-group sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Pump</span></a>
                                </li> 
                                 <li>
                                    <a href="<?php echo site_url(); ?>/#/Users" ><i class="fa  fa-user sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Users</span></a>
                                </li> 
                                <li>
                                    <a href="<?php echo site_url(); ?>/#/Customer" ><i class="fa  fa-users sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Customers</span></a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url(); ?>/#/Order" ><i class="fa  fa-shopping-cart sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Orders</span></a>
                                </li>
                               <li>
                                    <a href="<?php echo site_url(); ?>/#/Maintenance" ><i class="fa fa-wrench sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Maintenance</span></a>
                                </li>
                               <li>
                                    <a href="<?php echo site_url(); ?>/#/Stock" ><i class="fa fa-clock-o sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Stock</span></a>
                                </li>
<!-- 
                                
                                <li>
                                    <a href="<?php echo site_url(); ?>/#/Order" ><i class=" gi gi-shopping_cart sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Orders</span></a>
                                </li>
 -->
