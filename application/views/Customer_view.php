...
<div ng-show="!fgShowHide && !viewProfileDetail" style="display:none">
    ...
    <form action="#"  name="myForm" method="post" enctype="multipart/form-data"  onsubmit="return false;">
        ...
        <div class="form-group" ng-class="companynameError ? 'has-error':''">
            ...
            <input type="text" name="companyname" id="companyname" ng-model="item.CompanyName"  class="form-control" placeholder="Company Name" ng-focus="hideErrorMsg('companynameError')" ng-value="Bharat Cutting">
...
<div ng-show="viewProfileDetail" style="display:none">
    <div class="element-wrapper">
        ...
        <div class="col-md-8">
        	 <h6 class="element-header">Customer Statistics</h6>
