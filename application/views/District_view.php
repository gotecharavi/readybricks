<script src="static/appScript/DistrictCtrl.js"></script>
...
<div class="element-wrapper" ng-show="fgShowHide">
                ...
                <div class="element-box">
                  ...
                  <div class="table-responsive">
                        ...
                        <thead>
                            <tr>
                                <th>Country Name</th><th>State Name</th><th>District Name</th>
                        ...
                        <tbody>
                            ...
                            <tr ng-show="list.length ==0"><td colspan="10" class="text-center">District Not found</td></tr>
...
<div ng-show="!fgShowHide" style="display:none">
    <div class="element-wrapper">
                <h6 class="element-header">{{datatype}} District</h6>
    ...
    <form action="#"  name="myForm" method="post" enctype="multipart/form-data"  onsubmit="return false;">
        ...
        <div class="form-group" ng-class="nameError ? 'has-error':''">
            ...
            <input type="text" name="name" id="name" ng-model="item.Name"  class="form-control" placeholder="District Name" ng-focus="hideErrorMsg('nameError')">
