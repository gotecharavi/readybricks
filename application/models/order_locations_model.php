...
class Order_Locations_model extends CI_Model
{
    public $table = 'orders_locations';
...
// ->join('Navigations', 'Roles.NavigationId = Navigations.NavigationId', 'left outer');
    ...
    {
        return $this->db->where('LOrderDetailId', $id)->order_by('LocationId','DESC')->get($this->table)->row();
    }
